...
startup {
	...
	vars.journalEntries = new List<System.Text.RegularExpressions.Regex>(14);
	// Start
	vars.journalEntries.Add(
		new System.Text.RegularExpressions.Regex(@"\{ ""timestamp"":""(?<timestamp>.*)"", ""event"":""Undocked"", ""StationName"":""Somerset Station"", ""StationType"":"".*"", ""MarketID"":\d+(, ""Taxi"":(true|false), ""Multicrew"":(true|false))? \}"));
		// Stops
	for (int i=0; i<4; i++) {
		vars.journalEntries.Add(
			new System.Text.RegularExpressions.Regex(@"\{ ""timestamp"":""(?<timestamp>.*)"", ""event"":""FSDJump""(, ""Taxi"":(true|false), ""Multicrew"":(true|false))?, ""StarSystem"":""(Ennead|Khaka|Mikir|Sesuang)"", ""SystemAddress"":\d+, .*\}"));
		vars.journalEntries.Add(
			new System.Text.RegularExpressions.Regex(@"\{ ""timestamp"":""(?<timestamp>.*)"", ""event"":""SupercruiseExit""(, ""Taxi"":(true|false), ""Multicrew"":(true|false))?, ""StarSystem"":""(Ennead|Khaka|Mikir|Sesuang)"", ""SystemAddress"":\d+, ""Body"":""(Ennead B 2|Qureshi Enterprise|Harrison's Cradle|Sesuang A 3)"", ""BodyID"":\d+, ""BodyType"":""(Station|PlanetaryRing|Planet)"" \}"));
		vars.journalEntries.Add(
			new System.Text.RegularExpressions.Regex(@"\{ ""timestamp"":""(?<timestamp>.*)"", ""event"":""Docked"", ""StationName"":""(Lawhead Reach|Qureshi Enterprise|Harrison's Cradle|Shosuke Horizons)"", ""StationType"":"".*""(, ""Taxi"":(true|false), ""Multicrew"":(true|false))?, ""StarSystem"":""(Ennead|Khaka|Mikir|Sesuang)"", .*\}"));
		vars.journalEntries.Add(
			new System.Text.RegularExpressions.Regex(@"\{ ""timestamp"":""(?<timestamp>.*)"", ""event"":""StartJump"", ""JumpType"":""(Hyperspace|Supercruise)"", .*\}"));
	}
	// Return to H1T-06Y (Penny Benjamin)
	vars.journalEntries.Add(
		new System.Text.RegularExpressions.Regex(@"\{ ""timestamp"":""(?<timestamp>.*)"", ""event"":""FSDJump""(, ""Taxi"":(true|false), ""Multicrew"":(true|false))?, ""StarSystem"":""I Carinae"", ""SystemAddress"":594609703275, .*\}"));
	vars.journalEntries.Add(
		new System.Text.RegularExpressions.Regex(@"\{ ""timestamp"":""(?<timestamp>.*)"", ""event"":""SupercruiseExit""(, ""Taxi"":(true|false), ""Multicrew"":(true|false))?, ""StarSystem"":""I Carinae"", ""SystemAddress"":594609703275, ""Body"":""Somerset Station"", ""BodyID"":\d+, ""BodyType"":""Station"" \}"));
	vars.journalEntries.Add(
		new System.Text.RegularExpressions.Regex(@"\{ ""timestamp"":""(?<timestamp>.*)"", ""event"":""Docked"", ""StationName"":""Somerset Station"", ""StationType"":"".*""(, ""Taxi"":(true|false), ""Multicrew"":(true|false))?, ""StarSystem"":""I Carinae"", .*\}"));
